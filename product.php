...
<div class="product content-wrapper">
    ...
    <div class="product-imgs" style="padding:2px;">

        <?php if (!empty($product['img']) && file_exists('imgs/' . $product['img'])): ?>
        <img class="product-img-large" style="float:right;width:40%;height:40%;" src="<?=base_url?>imgs/<?=$product['img']?>" alt="<?=$product['name']?>">
        <?php endif; ?>

        <div class="product-small-imgs" style="padding:6px;float:left;width:50%;height:50%;">
    ...
    <div class="product-wrapper">
        ...
        <h1 class="name"  style="float:right;"><?=$product['name']?></h1>
        <br>
        <br>        
        <br>
    <span class="price" style="float:right;">
        ...
        <div style="float:right;text-align:right;" class="description">
            <?=$product['description']?>
        </div>
