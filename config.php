...
define('stripe_ipn_url','http://localhost/shoppingcart/ipn/stripe');
// PayPal cancel URl, the page the customer returns to when they cancel the payment
define('stripe_cancel_url','http://localhost/shoppingcart/cart');
// PayPal return URL, the page the customer returns to after the payment has been made
define('stripe_return_url','http://localhost/shoppingcart/placeorder');
?>
