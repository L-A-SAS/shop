	...
	<body>
        <header>
            <div class="content-wrapper">
               <a href="https://doorban.org/shoppingcart/index.php" style="text-decoration:none;"> <h1>KadureiPele</h1> </a>
                <nav>
                    <a href="$home_link">בית</a>
                    <a href="$products_link">חנות</a>
					<a href="$myaccount_link">החשבון שלי</a>
                    $admin_link
                </nav>
...
echo <<<EOT
        ...
        <footer>
            <div class="content-wrapper">
                <p style="text-align:center;">&copy; $year,<!--logo-->
                    <a target="_blank" href="https://doorban.org/buissnes_card/index.php"><img src="imgs/dblogo1234.png" style="width:75px;marging-bottom:0px;"/></a>.org Web Guide</p>
            </div>
        </footer>
        <script>
